...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('user/view/statistics', [UserManagementController::class, 'userViewStatistics'])->name('user-view-statistics');
    Route::get('user/view/connections', [UserManagementController::class, 'userViewConnections'])->name('user-view-connections');
    Route::get('user/view/notifications', [UserManagementController::class, 'userViewNotifications'])->name('user-view-notifications');
    ...
    Route::get('po/notifications', [UserManagementController::class, 'poViewNotifications'])->name('po-view-notifications');
